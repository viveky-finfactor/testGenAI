...
public class CodeReader {
    ...
    public static String extractMethods(Class<?> clazz) {
        StringBuilder methodDetails = new StringBuilder();

        Method[] methods = clazz.getDeclaredMethods();
        for (Method method : methods) {
            methodDetails.append("Method: ").append(method.getName()).append("\n");
            methodDetails.append("Parameters: ").append(Arrays.toString(method.getParameterTypes())).append("\n");
        }
